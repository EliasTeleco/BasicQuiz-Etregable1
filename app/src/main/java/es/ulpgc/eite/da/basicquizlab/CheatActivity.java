...
public class CheatActivity extends AppCompatActivity {
  ...
  private static final String KEY_ANSWCHEAT = "KEY_ANSWCHEAT";

  private Button noButton, yesButton;
  private TextView answerText;

  private int currentAnswer;
  private boolean answerCheated = false;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if(savedInstanceState != null) {
      ...
      answerCheated=savedInstanceState.getBoolean(KEY_ANSWCHEAT);
  ...
  protected void onSaveInstanceState(Bundle outState) {
    ...
    outState.putBoolean(KEY_ANSWCHEAT, answerCheated);
    Log.d(TAG, String.valueOf(answerCheated));

  }
  private void updateLayoutContent() {
        //Si le hemos dado anteriormente a yes se cargara dicho estado.
